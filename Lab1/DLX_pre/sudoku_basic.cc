...
static void find_spaces(int board[N],int spaces[N])//标记空格 若spaces[x]==1，则chess[x/9][x%9]为空格 
{
  nspaces = 0;
...
bool solve_sudoku_basic(int which_space,int board[N],int spaces[N])//填第which_space个空格 
{
